...
import uniontool.co.jp.whs_2_android_with_wear.correspond.GoogleApiClientController;
import uniontool.co.jp.whs_2_android_with_wear.le.WhsCommandContainer;
import uniontool.co.jp.whs_2_android_with_wear.le.WhsCommands;
import uniontool.co.jp.whs_2_android_with_wear.le.WhsGattAttributes;
import uniontool.co.jp.whs_2_android_with_wear.le.WhsHelper;
import uniontool.co.jp.whs_2_android_with_wear.receiveddata.SerializableReceivedData;
import uniontool.co.jp.whs_2_android_with_wear.receiver.MeasureReceiver;
import uniontool.co.jp.whs_2_android_with_wear.receiver.ReceiveUtility;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "uniontool.co.jp.whs2mybeatandroidwithwear.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "uniontool.co.jp.whs2mybeatandroidwithwear.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "uniontool.co.jp.whs2mybeatandroidwithwear.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE_MEASURE =
            "uniontool.co.jp.whs2mybeatandroidwithwear.ACTION_DATA_AVAILABLE_MEASURE";
    public final static String ACTION_DATA_AVAILABLE_SETTING =
            "uniontool.co.jp.whs2mybeatandroidwithwear.ACTION_DATA_AVAILABLE_SETTING";
    ...
    private void receiveMeasure(final String action, final byte[] data) {
        ...
        if (receiver != null) {
            ...
            //追加
            mGoogleApiClientController.sendData(receivedData);
        }
        sendBroadcast(intent);
    }
    ...
    public boolean connect(final String address) {
        ...
        //追加
        //GoogleApiClientControllerの初期設定を行った後にWear側との接続を開始する.
        if (mGoogleApiClientController == null) {
            mGoogleApiClientController = new GoogleApiClientController(getApplicationContext());
        }
    ...
    public void close() {
        ...
        mBluetoothGatt = null;
        //追加
        //GoogleApiClientと接続している場合は切断処理を行う.
        if (mGoogleApiClientController.isConnected()) {
