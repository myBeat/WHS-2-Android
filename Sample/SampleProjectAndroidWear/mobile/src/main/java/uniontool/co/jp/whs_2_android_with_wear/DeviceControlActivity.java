...
import uniontool.co.jp.whs_2_android_with_wear.receiveddata.PqrstData;
import uniontool.co.jp.whs_2_android_with_wear.receiveddata.RriAverageData;
...
public class DeviceControlActivity extends Activity {
    ...
    //変更
    //BluetoothLeServiceを停止するタイミングをonPause→onDestroyに変更.
    @Override
	...
	private void displayData(final SerializableReceivedData data) {
		if (data != null) {
			if (data instanceof PqrstData) {
				...
				mRri.setText(Integer.toString(data.getEcg()));
                mHeartRate.setText(Integer.toString(60000/data.getEcg()));
			}
